...
#define STRING_SPLASH_LINE1 "2.0-MMU" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "MakerFr I3-Rs"         // will be shown during bootup in line 2
